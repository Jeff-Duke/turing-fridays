...
export default class Admin extends Component {
  ...
  render() {
    ...
    let adminList = <AdminList toggleList={()=>this.setState({ adminList: !adminList })} allAdmins={allAdmins} newAdmin={newAdmin}/>

    return (
      <section className='Admin'>
        <button className='OpenAdminsListButton' onClick={() => this.setState({ adminList: true })}>Admins List</button>
