...
export default class Admin extends Component {
  ...
  openAdminsList() {
    ...
    document.querySelector('.AdminsList').style.width = '320px';
  ...
  render() {
    ...
    return (
      <section className='Admin'>
        <button className='OpenAdminsListButton' onClick={() => this.openAdminsList()}>Admins List</button>
        ...
        <section className='AdminsList'>
          <button className='CloseListButton' onClick={() => this.closeAdminsList()}>Close</button>
